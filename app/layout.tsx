  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`font-sans ${GeistSans.variable} ${GeistMono.variable}`}>
            ...
            <div className="nav-shell">
              <div className="nav-row">
                ...
                <a href="/" aria-label="home" className="brand">
                  {/* Logo SVG 1:1 z komponentu */}
                  <svg viewBox="0 0 78 18" xmlns="http://www.w3.org/2000/svg" className="logo">
                    <defs>
                  ...
                  <span className="brand-text">tailark</span>
                </a>
        ...
        <Script src="/problem-lines.js" strategy="afterInteractive" />
      </body>
    </html>
  )
}
